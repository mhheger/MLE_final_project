...
def end_of_round(self, last_game_state: dict, last_action: str, events: List[str]):
    ...
    with open("renate_colab-model.pt", "wb") as file:
...
def reward_from_events(self, events: List[str]) -> int:
    ...
    *This is not a required function, but an idea to structure your code.*
    ...
    game_rewards = {
        ...
        e.INVALID_ACTION: -10 ,
        e.BOMB_DROPPED: 2,
        DECREASE_COIN_DISTANCE: 3,
        INCREASE_COIN_DISTANCE: -3,
        INCREASE_BOMB_EFFECT: 0,
        DECREASE_BOMB_EFFECT: 0,
        EXIT_DANGER_ZONE : 3,
        ENTER_DANGER_ZONE : 0,
        INCREASE_RISK : -2,
        DECREASE_RISK : 5,
        CRATE_WILL_BE_DESTROYED: 0,
        #WILL_DIE: -60,  
        ENTER_EXPLOSION_AREA: -3,
        CORRECT_DIRECTION: 0,
...
def optimize_model(self, transition_batch):
    ...
    optimizer = optim.AdamW(self.model.policy_net.parameters(), lr=lr)
